...
import com.ex.junit5lecture.dummy.User;
...
public class AssertionsTest {
    ...
    void unusedAssertAllTest() {
        Assertions.assertThat(user.getName()).isEqualTo("lee"); // 테스트 실패.
        Assertions.assertThat(user.getAge()).isLessThan(26); // 위 실패로 실행되지 않음.
    ...
    void assertAllTest() {
        assertAll(
                ...
                () -> Assertions.assertThat(user.getAge()).isLessThan(26)
        );
    ...
    void assertTimeoutTest() {
        assertTimeout(Duration.ofMillis(100), () -> user.logic()); // 소요시간 확인
        // logic() 3000ms 소요
    ...
    void assertTimeoutPreemptivelyTest() {
        assertTimeoutPreemptively(Duration.ofMillis(100), () -> user.logic()); // 소요시간 확인
        // logic() 3000ms 소요
